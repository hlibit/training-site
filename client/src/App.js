...
import YourTraining from "./components/mainPage/yourTrainings/yourTrainings";
import History from "./components/mainPage/historyTraining/historyTraining";
      ...
      <div className="App">
        <Router>
          <Routes>
            ...
            <Route path="/main/your-trainings" element={<YourTraining />} />
